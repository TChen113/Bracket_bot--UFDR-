...
def main():
    ...
    rr.log(
        "world/whiteboard",
        rr.Boxes3D(
            centers=[[0.41, 0.0, 1.10]],           
            half_sizes=[[0.01, 0.915, 0.61]],       
            colors=[[245, 245, 250, 180]],         
        ),
        static=True,
    )

    rr.log(
        "world/whiteboard/canvas_target",
        rr.Boxes3D(
            centers=[[0.40, -0.15, 1.05]],        
            half_sizes=[[0.001, 0.25, 0.25]],      
            colors=[[50, 150, 255, 120]],          
        ),
        static=True,
    )
    if args.save:
